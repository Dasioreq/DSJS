$(document).ready(function()
{
    ...
    {
        $("div#ship").css({"transform": `translate(${-event.pageX / $(window).width() * 5 + 2.5}%, ${-event.pageY / $(window).height() * 5 + 2.5}%)`})
    })
    ...
    {
        $("div#ship > img").attr("src", "../assets/ShipCrew.png")
    })
    $("div#ship > div#crew").mouseleave(function(event)
    {
        $("div#ship > img").attr("src", "../assets/Ship.png")
    })
    ...
    {
        $("div#ship > img").attr("src", "../assets/ShipFire.png")
    })
    ...
    {
        $("div#ship > img").attr("src", "../assets/ShipInfirmary.png")
    })
    ...
    {
        $("div#ship > img").attr("src", "../assets/ShipRecharge.png")
    })
    ...
    {
        $("div#ship > img").attr("src", "../assets/ShipRepair.png")
    })
